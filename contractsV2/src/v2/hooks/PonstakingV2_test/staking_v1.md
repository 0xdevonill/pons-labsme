...
The **open staking contract is expected to go live within the next 24 hours**, at which point the staking mechanism will become publicly accessible, with **$PONSTAKE being the first token available for staking**.
...
```text
0x97f6Ea36d41A595256eb2fdDB75FF139ADb8789f
```
